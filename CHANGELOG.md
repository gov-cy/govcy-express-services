...
## [v1.3.0-alpha.7] - 2025-10-21
### Changed
- Fixes and enhancements after feedback

## [v1.3.0-alpha.6] - 2025-10-20
### Added
- Date of birth with `dob` scope on `Update my details`

### Changed
- Fixed address to include POBox and unstructured address on `Update my details`

## [v1.3.0-alpha.5] - 2025-10-16
### Changed
- Fixed persistent error messages on `Update my details`

## [v1.3.0-alpha.4] - 2025-10-16
### Changed
- Use the email from `Update my details` feature to send the actual email. If not provided use the email from the user profile
...
- CRMD Eligibility checks in `test.json`
- More unit tests

### Changed
- Fixed vulnerabilities
- Corrected multiple things content
